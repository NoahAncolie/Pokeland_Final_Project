...
import { Texture, Scene, Loader, CubeTexture } from 'three';
...
export declare function useEnvironment({ files, path, preset, extensions, }: Partial<Props>): Texture | CubeTexture;
