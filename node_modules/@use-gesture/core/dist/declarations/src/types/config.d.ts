...
export declare type CoordinatesKey = Exclude<GestureKey, 'pinch'>;
export declare type GenericOptions = {
    /**
...
export declare type GestureOptions<T extends GestureKey> = GenericOptions & {
    /**
...
export declare type CoordinatesConfig<Key extends CoordinatesKey = CoordinatesKey> = GestureOptions<Key> & {
    /**
...
export declare type PinchBounds = {
    min?: number;
    max?: number;
};
...
export declare type UserDragConfig = GenericOptions & DragConfig;
export declare type UserPinchConfig = GenericOptions & PinchConfig;
export declare type UserWheelConfig = GenericOptions & CoordinatesConfig<'wheel'>;
