(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('jotai')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', 'jotai'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.jotaiDevtools = {}, global.React, global.jotai));
})(this, (function (exports, react, jotai) { 'use strict';
  ...
  function useAtomsDevtools(name, options) {
    ...
    react.useEffect(function () {
      ...
      var callback = function callback() {
        ...
        for (var _iterator = _createForOfIteratorHelperLoose(((_store$DEV_GET_MOUNTE = store[DEV_GET_MOUNTED_ATOMS]) == null ? void 0 : _store$DEV_GET_MOUNTE.call(store)) || []), _step; !(_step = _iterator()).done;) {
          var _store$DEV_GET_MOUNTE, _store$DEV_GET_ATOM_S, _store$DEV_GET_MOUNTE2;
          ...
          var mounted = (_store$DEV_GET_MOUNTE2 = store[DEV_GET_MOUNTED]) == null ? void 0 : _store$DEV_GET_MOUNTE2.call(store, atom);
        ...
        setAtomsSnapshot(function (prev) {
    ...
    var goToSnapshot = react.useCallback(function (snapshot) {
