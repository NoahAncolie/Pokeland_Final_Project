(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@urql/core'), require('jotai'), require('wonka')) :
  typeof define === 'function' && define.amd ? define(['exports', '@urql/core', 'jotai', 'wonka'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.jotaiUrql = {}, global.core, global.jotai, global.wonka));
})(this, (function (exports, core, jotai, wonka) { 'use strict';
  ...
  function atomWithQuery(createQueryArgs, getClient) {
    ...
    var queryResultAtom = jotai.atom(function (get) {
      ...
      var resolve = null;
      var baseResultAtom = jotai.atom(new Promise(function (r) {
        resolve = r;
      }));
      ...
      client.query(args.query, args.variables, _extends({}, args.requestPolicy && {
        requestPolicy: args.requestPolicy
      }, args.context)).toPromise().then(listener).catch(function () {});

      baseResultAtom.onMount = function (update) {
        setResult = update;
      };

      var subscriptionAtom = jotai.atom(null);
      var resultAtom = jotai.atom(function (get) {
        return get(baseResultAtom);
      }, function (get, set, callback) {
        var subscription = wonka.pipe(client.query(args.query, args.variables, _extends({}, args.requestPolicy && {
          requestPolicy: args.requestPolicy
        }, args.context)), wonka.skip(1), wonka.subscribe(listener));
        set(subscriptionAtom, subscription);
        callback(function () {
          var _get;

          return (_get = get(subscriptionAtom)) == null ? void 0 : _get.unsubscribe();
        });
      });

      resultAtom.onMount = function (init) {
        var cleanup;
        init(function (c) {
          cleanup = c;
        });
      ...
      return {
        ...
        subscriptionAtom: subscriptionAtom,
        listener: listener
      };
    });
        ...
        case 'reexecute':
          {
            ...
            var args = queryResult.args,
                client = queryResult.client,
                subscriptionAtom = queryResult.subscriptionAtom,
                listener = queryResult.listener;
            listener(new Promise(function () {}));
            var newSubscription = wonka.pipe(client.query(args.query, args.variables, _extends({}, args.requestPolicy && {
              requestPolicy: args.requestPolicy
            }, args.context, action.opts)), wonka.subscribe(listener));
            var oldSubscription = get(subscriptionAtom);
